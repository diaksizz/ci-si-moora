                ...
                <div class="col-md-3">
                  ...
                  <div class="form-group">
                    ...
                    <select name="bank" class="form-control" required="required">
                      ...
                      ?>
                        <option <?php if (isset($_GET['bank_nama'])) {
                                  if ($_GET['bank_nama'] == $k['bank_id']) {
                                    echo "selected='selected'";
                                  }
                                } ?> value="<?php echo $k['bank_id']; ?>"><?php echo $k['bank_nama']; ?></option>
                      <?php
                      }
                      ?>
                    </select>
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            ?>
              ...
              <a href="laporan_print.php?tanggal_dari=<?php echo $tgl_dari ?>&tanggal_sampai=<?php echo $tgl_sampai ?>&bank=<?php echo $bank ?>" target="_blank" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> &nbsp PRINT</a>
