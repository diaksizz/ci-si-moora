...
mysqli_query($koneksi, "insert into transaksi values (NULL,'$tanggal','$jenis','$bank','$nominal','$keterangan','$kategori')") or die(mysqli_error($koneksi));
header("location:tmasuk.php");
