  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        <span class="logo-mini"><b><i class="fa fa-bars"></i></b> </span>
        <span class="logo-lg"><b>Bendahara</span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xs">Bendahara</span>
              </a>
            </li>
            <li>
    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="santri.php">
              <i class="fa fa-user"></i> <span>DATA SANTRI</span>
            </a>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu" style="display: none;">
              <li><a href="tmasuk.php"><i class="fa fa-circle-o"></i> Transaksi Masuk</a></li>
              <li><a href="tkeluar.php"><i class="fa fa-circle-o"></i> Transaksi Keluar</a></li>
              <li><a href="detail_transaksi.php"><i class="fa fa-circle-o"></i> Detail Transaksi</a></li>
              <li><a href="bank.php"><i class="fa fa-circle-o"></i> Data Kas</a></li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu" style="display: none;">
              ...
              <li><a href="m_alternatif.php"><i class="fa fa-circle-o"></i> Alternatif</a></li>
              <li><a href="m_hasil.php"><i class="fa fa-circle-o"></i> Hasil</a></li>
			  <li><a href="m_laporan.php" target="_blank"><i class="fa fa-circle-o"></i> Laporan Moora</a></li>
            </ul>
          </li>
